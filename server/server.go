...
func (s *Server) Start() (*sync.WaitGroup, error) {
	...
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/auth", s.dockerAuthHandler).Methods("POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/version", s.dockerVersionHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/info", s.dockerInfoHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/json", s.containersHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/create", s.containerCreateHandler).Methods("POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}/json", s.containerInspectHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}", s.containerRemoveHandler).Methods("DELETE")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}/restart", s.containerRestartHandler).Methods("GET", "POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}/start", s.containerStartHandler).Methods("POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}/stop", s.containerStopHandler).Methods("POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}/top", s.containerTopHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}/changes", s.containerChangesHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}/kill", s.containerKillHandler).Methods("POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/containers/{containerId:.*}/export", s.containerExportHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/images/json", s.imagesHandler).Methods("GET", "POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/images/create", s.imageCreateHandler).Methods("POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/images/{imageName:.*}/history", s.imageHistoryHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/images/{imageName:.*}/search", s.imageSearchHandler).Methods("GET")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/images/{imageName:.*}/tag", s.imageSearchHandler).Methods("POST")
	s.Router.HandleFunc("/{apiVersion:v1.[7-10]}/images/{imageName:.*}", s.imageDeleteHandler).Methods("DELETE")
